...
class Manager_TestSprite(cdkk.SpriteManager):
    def __init__(self, name = "Test PyGame App Manager"):
        ...
        self._board1.setup_board_grid(cell_size, cols, cdkk.EventManager.gc_event("Board1"))
        self._board1.rect.topleft = (40,40)
        self.add(self._board1)

        self._board2 = cdkk.Sprite_BoardGame_Board(name="Board2", style={"fillcolour":"green", "altcolour":None, "outlinecolour":"black", "outlinewidth":2})
        self._board2.setup_board_grid(cell_size, cols, cdkk.EventManager.gc_event("Board2"))
        self._board2.rect.topleft = (400,50)
        self.add(self._board2)

        self._board3 = cdkk.Sprite_BoardGame_Board(name="Board3", style={"fillcolour":None, "altcolour":None, "fillimage":"board.png", "outlinecolour":None})
        self._board3.setup_board_grid(cell_size, cols)
        self._board3.rect.topleft = (800,50)
        self.add(self._board3, layer=9)

        self._piece1 = cdkk.Sprite_BoardGame_Piece("Piece1", self._board3, style={"fillcolour":"red4"})
        self.add(self._piece1)
        self._piece2 = cdkk.Sprite_BoardGame_Piece("Piece2", self._board3, col=3, style={"fillcolour":"yellow2", "piecemargin":0})
        self.add(self._piece2)

        self._grid1 = cdkk.Sprite_ImageGrid()
        self._grid1.setup_grid((3,2), (32,32))
        self._grid1.setup_image_grid(["ExplosionCount.png",4,4], [1,3,5,7,9,11])
